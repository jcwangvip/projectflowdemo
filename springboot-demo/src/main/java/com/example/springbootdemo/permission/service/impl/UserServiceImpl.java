...
import com.example.springbootdemo.permission.repository.UserRepository;
import com.example.springbootdemo.permission.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    public ResultVO<UserEntity> save(UserForm userForm) {
        ...
        userForm.setRoleEntityList(roleEntityList);
